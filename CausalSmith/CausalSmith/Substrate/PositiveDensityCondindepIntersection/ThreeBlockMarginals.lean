...
/-- Pushing a measurable three-block product density to the conditioning coordinate gives the
conditioning reference measure weighted by the iterated marginal density. -/
