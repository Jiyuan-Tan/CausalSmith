...
/-- For four pairwise-disjoint finite coordinate blocks and a finite law with an almost-everywhere
strictly positive density relative to the coordinate product measure, the two intersection
premises imply conditional independence of the first block from the union of the second and third
blocks given the fourth block. -/
...
/-- Under the same pairwise-disjoint positive-density hypotheses, the first coordinate block is
conditionally independent of the second block alone given the fourth block. -/
