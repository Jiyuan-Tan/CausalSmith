module
public import CausalSmith.Substrate.Archive.FiniteSideInformationMinimaxConvergence.Comparison
public import CausalSmith.Substrate.Archive.FiniteSideInformationMinimaxConvergence.Concentration
public import CausalSmith.Substrate.Archive.FiniteSideInformationMinimaxConvergence.Selector
...
theorem finiteCover_approximateDecision
  ...
  -- all conditional-completeness hypotheses for `worstCaseRiskReal` and `minimaxValueReal`.
  classical
  ...
  have hlocal (theta0 : Theta) : ∃ (d : BoundedDecision X l u) (r : ℝ),
    ...
    have hvalue : (⨅ d, Causalean.Stat.worstCaseRiskReal localRisk d) <
      ...
      simpa [localMinimaxValue, Causalean.Stat.minimaxValueReal, localRisk] using hlocal_lt
