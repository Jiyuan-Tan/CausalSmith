...
/-- Given [finitely many centers](hyp:center), a [positive radius](hyp:hr), and at least one
center, there is a [measurable selector](goal) that chooses a center within the radius at every
point covered by the corresponding open balls. -/
