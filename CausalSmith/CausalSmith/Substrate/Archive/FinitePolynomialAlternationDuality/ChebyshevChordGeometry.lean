...
module
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.CenteredRemainder
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.ChebyshevChordFactorization
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.ChebyshevChordOrdering
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.ChebyshevChordPermutation
...
/-- Every vertical root-distance product above `[-1,1]` is dominated at an
abscissa in `[-1,1]` lying weakly to the right of every degree-`L` Chebyshev
root.
