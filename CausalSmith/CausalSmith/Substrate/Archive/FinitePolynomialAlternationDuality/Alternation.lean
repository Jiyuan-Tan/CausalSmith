...
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.Equioscillation
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.LagrangeWeights
...
weights on those nodes, with the exact oriented target evaluation. -/
...
target by exactly its best uniform approximation error. -/
