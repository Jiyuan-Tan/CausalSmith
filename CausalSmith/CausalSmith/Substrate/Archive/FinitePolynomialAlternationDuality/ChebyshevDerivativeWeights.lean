...
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.ChebyshevRootDerivativePropagation
public import CausalSmith.Substrate.Archive.FinitePolynomialAlternationDuality.ChebyshevZeroDerivativeComparison
...
derivative at `x` of the corresponding Lagrange cardinal polynomial. -/
...
differentiation weights is at most `L²` when `L` is positive. -/
