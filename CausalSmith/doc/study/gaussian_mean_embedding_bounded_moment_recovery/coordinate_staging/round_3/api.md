...
## Mathlib/Probability/GaussianMeanEmbedding — Gaussian mean embeddings on bounded supports

This module realizes the real Gaussian kernel by explicit square-summable weighted monomials.
For finite measures concentrated on one bounded interval, equality of the resulting Bochner mean
embeddings recovers the measure itself, its raw second moment, and strict embedding separation
whenever second moments differ.

<!-- GEN:Causalean.Mathlib.Probability.GaussianMeanEmbedding -->
| Decl | Signature | Description |
|---|---|---|
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianKernel` | `ℝ → ℝ → ℝ` | Given two real inputs, the Gaussian kernel is the exponential of their negative squared difference as specified by the displayed formula. |
| `Mathlib.Probability.GaussianMeanEmbedding.UnitNormGaussianFeatureMap` | `(H : Type u_1) → [inst : NormedAddCommGroup H] → [InnerProductSpace ℝ H] → Type u_1` | Given a real Hilbert space, a unit-norm Gaussian feature map consists of an input-to-vector assignment, a unit-norm certificate, and a Gaussian inner-product identity. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureNormalization` | `ℕ → ℝ` | Given a natural-number coordinate, its Gaussian feature normalization is the positive square-root factor specified by the displayed formula. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureNormalization_pos` | `0 < Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureNormalization m` | A natural-number coordinate has a strictly positive Gaussian feature normalization. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureCoefficient` | `ℝ → ℕ → ℝ` | Given a real input and a natural-number coordinate, the explicit Gaussian feature coefficient is the normalized exponentially weighted monomial specified by the displayed formula. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature_memℓp` | `Memℓp (Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureCoefficient r) 2` | At a real input, the sequence of explicit Gaussian feature coefficients is square-summable. |
| `Mathlib.Probability.GaussianMeanEmbedding.GaussianHilbert` | `AddSubgroup (PreLp fun x => ℝ)` | The Gaussian Hilbert space is the complete real square-summable sequence space given by sequences indexed by nonnegative integers. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature` | `ℝ → ↥Causalean.Mathlib.Probability.GaussianMeanEmbedding.GaussianHilbert` | Given a real input, the explicit Gaussian feature vector is its square-summable coefficient sequence given by the preceding coefficients and their square-summability certificate. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature_inner` | `inner ℝ (Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature a) (Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature b) = Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianKernel a b` | For two real inputs, the inner product of their explicit Gaussian feature vectors equals the Gaussian kernel. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature_norm` | `‖Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature r‖ = 1` | At a real input, the explicit Gaussian feature vector has norm one. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap` | `Causalean.Mathlib.Probability.GaussianMeanEmbedding.UnitNormGaussianFeatureMap ↥Causalean.Mathlib.Probability.GaussianMeanEmbedding.GaussianHilbert` | The explicit unit-norm Gaussian feature realization is given by the weighted monomial feature vector, its unit norm, and its Gaussian inner-product identity. |
| `Mathlib.Probability.GaussianMeanEmbedding.UnitNormGaussianFeatureMap.continuous` | `Continuous U.feature` | Given a unit-norm Gaussian feature realization, its feature map is continuous on the real line. |
| `Mathlib.Probability.GaussianMeanEmbedding.UnitNormGaussianFeatureMap.integrable` | `MeasureTheory.Integrable U.feature μ` | Given a complete real Hilbert space and its unit-norm Gaussian feature realization and a finite real measure, the feature map is Bochner-integrable. |
| `Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding` | `MeasureTheory.Measure ℝ → H` | Given a complete real Hilbert-space Gaussian feature realization and a real measure, its Gaussian mean embedding is given by the Bochner integral of the feature map. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianCoordinate` | `ℕ → ↥Causalean.Mathlib.Probability.GaussianMeanEmbedding.GaussianHilbert →L[ℝ] ℝ` | Given a natural-number coordinate, the continuous Gaussian coordinate evaluation is given by evaluation in the real square-summable sequence space. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianCoordinate_feature` | `(Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianCoordinate m) (Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeature r) = Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureCoefficient r m` | For a coordinate and a real input, evaluating the explicit Gaussian feature at that coordinate returns its defining coefficient. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianCoordinate_meanEmbedding` | `(Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianCoordinate m) (Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap μ) = ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureCoefficient r m ∂μ` | Given a finite real measure and a coordinate, coordinate evaluation of its explicit Gaussian mean embedding commutes with the Bochner integral. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianWeight` | `ℝ → ℝ` | Given a real input, the Gaussian weight is the positive exponential weight specified by the displayed formula. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial` | `ℕ → ℝ → ℝ` | Given a natural-number degree and a real input, the Gaussian-weighted monomial is the Gaussian weight times that raw monomial. |
| `Mathlib.Probability.GaussianMeanEmbedding.integrable_gaussianWeightedMonomial` | `MeasureTheory.Integrable (Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m) μ` | Given a finite real measure and a natural-number degree, the Gaussian-weighted monomial is Bochner-integrable. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedPolynomial_integral_eq` | `(∀ (m : ℕ), ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂μ = ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂ν) → ∀ (p : Polynomial ℝ), ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeight r * Polynomial.eval r p ∂μ = ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeight r * Polynomial.eval r p ∂ν` | Given two finite real measures, equality of all their Gaussian-weighted monomial integrals, and a real polynomial, their Gaussian-weighted polynomial integrals are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.continuousIntegral_eq_of_gaussianWeightedMoments_eq` | `0 ≤ B → μ (Set.Icc (-B) B)ᶜ = 0 → ν (Set.Icc (-B) B)ᶜ = 0 → (∀ (m : ℕ), ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂μ = ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂ν) → ∀ (f : ℝ → ℝ), Continuous f → ∫ (r : ℝ), f r ∂μ = ∫ (r : ℝ), f r ∂ν` | Given two finite real measures, a nonnegative common support radius, their concentration on that closed interval, equality of every Gaussian-weighted monomial integral, and a continuous real test function, their integrals of that test function are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.measure_eq_of_continuousIntegral_eq` | `(∀ (f : ℝ → ℝ), Continuous f → ∫ (r : ℝ), f r ∂μ = ∫ (r : ℝ), f r ∂ν) → μ = ν` | Given two finite real measures that have equal integrals against every continuous real test function, the measures are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.measure_eq_of_gaussianWeightedMoments_eq` | `0 ≤ B → μ (Set.Icc (-B) B)ᶜ = 0 → ν (Set.Icc (-B) B)ᶜ = 0 → (∀ (m : ℕ), ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂μ = ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂ν) → μ = ν` | Given two finite real measures, a nonnegative common support radius, their concentration on that closed interval, and equality of every Gaussian-weighted monomial integral, the measures are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMoments_eq_of_meanEmbedding_eq` | `Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap μ = Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap ν → ∀ (m : ℕ), ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂μ = ∫ (r : ℝ), Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianWeightedMonomial m r ∂ν` | Given two finite real measures, equality of their explicit Gaussian mean embeddings, and a natural-number degree, their Gaussian-weighted monomial integrals at that degree are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.measure_eq_of_meanEmbedding_eq_of_boundedSupport` | `0 ≤ B → μ (Set.Icc (-B) B)ᶜ = 0 → ν (Set.Icc (-B) B)ᶜ = 0 → Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap μ = Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap ν → μ = ν` | Given two finite real measures, a nonnegative common support radius, their concentration on that closed interval, and equal explicit Gaussian mean embeddings, the measures are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.secondMoment_eq_of_meanEmbedding_eq_of_boundedSupport` | `0 ≤ B → μ (Set.Icc (-B) B)ᶜ = 0 → ν (Set.Icc (-B) B)ᶜ = 0 → Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap μ = Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap ν → ∫ (r : ℝ), r ^ 2 ∂μ = ∫ (r : ℝ), r ^ 2 ∂ν` | Given two finite real measures, a nonnegative common support radius, their concentration on that closed interval, and equal explicit Gaussian mean embeddings, their raw second moments are equal. |
| `Mathlib.Probability.GaussianMeanEmbedding.norm_meanEmbedding_sub_pos_of_secondMoment_ne_of_boundedSupport` | `0 ≤ B → μ (Set.Icc (-B) B)ᶜ = 0 → ν (Set.Icc (-B) B)ᶜ = 0 → ∫ (r : ℝ), r ^ 2 ∂μ ≠ ∫ (r : ℝ), r ^ 2 ∂ν → 0 < ‖Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap μ - Causalean.Mathlib.Probability.GaussianMeanEmbedding.meanEmbedding Causalean.Mathlib.Probability.GaussianMeanEmbedding.gaussianFeatureMap ν‖` | Given two finite real measures, a nonnegative common support radius, their concentration on that closed interval, and unequal raw second moments, the norm of the difference between their explicit Gaussian mean embeddings is strictly positive. |
