...
## Mathlib/Probability/CertifiedFiniteMarkovExpectation/Chunked — bounded-memory interval recurrence certificates

This module composes independently checked rational scalar leaves and bounded finite-sum chunks into interval-vector Markov recurrences, then adapts the trace to the established stationary-expectation API.

<!-- GEN:Causalean.Mathlib.Probability.CertifiedFiniteMarkovExpectation.Chunked -->
<!-- /GEN -->
