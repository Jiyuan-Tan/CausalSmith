...
### Smooth Z-estimator bootstrap validity

Smooth finite-dimensional estimating equations admit bootstrap linearizations under the same
regularity package used for sampling asymptotic linearity. The modules below package the data
and conditional-root conditions, then provide the generic contrast result together with OLS and
feasible-GMM specializations.
...
<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.OLS -->
<!-- /GEN -->
