...
[an iid sample and sample-function estimator](hyp:S,est), [data and bootstrap
consistency](hyp:hConsistent,hBootConsistent), and [data and bootstrap solution of the estimating
equation](hyp:hSolve,hBootSolve), [the conditional bootstrap vector linearization remainder
vanishes in bootstrap probability, in outer sampling probability](goal). -/
