...
### Bootstrap validity for smooth Z-estimators and GMM

These modules turn the smooth finite-dimensional Z-estimator and feasible-GMM expansions already
used for asymptotic normality into Efron-bootstrap validity for scalar contrasts, including OLS.

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.SamplingLinearization -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.BootstrapLinearization -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.Main -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.FeasibleGMM -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.FeasibleGMM.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.FeasibleGMM.Expansion -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.FeasibleGMM.Linearization -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.SmoothZEstimator.FeasibleGMM.Main -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.LinearModel.OLSBootstrap -->
<!-- /GEN -->
...
| `Stat.Minimax.FiniteSideInformation.worstCaseRisk_comp_surjective` | `Function.Surjective phi → Causalean.Stat.worstCaseRisk (fun e a => risk e (phi a)) e = Causalean.Stat.worstCaseRisk risk e` | Given a risk, a fixed procedure, a parameter map, and surjectivity of that map, reindexing leaves the worst-case risk unchanged. |
| `Stat.Minimax.FiniteSideInformation.minimaxValue_comp_surjective` | `Function.Surjective phi → (Causalean.Stat.minimaxValue fun e a => risk e (phi a)) = Causalean.Stat.minimaxValue risk` | Given a risk, a parameter map, and surjectivity of that map, reindexing leaves the minimax value unchanged. |
