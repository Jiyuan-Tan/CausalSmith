import Causalean.Mathlib.Probability.CertifiedFiniteMarkovExpectation.CertifiedNormalCDFEnclosure.Exponential
import Causalean.Mathlib.Probability.CertifiedFiniteMarkovExpectation.CertifiedNormalCDFEnclosure.Normalization
...
and upper-factor product with the certified density interval. -/
...
negative endpoint and reflects it for a positive endpoint. -/
