...
/-- The vertical stack of two real linear maps with a common domain sends a vector to its pair
of component outputs, equipped with the Hilbert direct-sum norm. -/
