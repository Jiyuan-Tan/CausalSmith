...
/-- The zero-inflated prior obtained by weighting the variation probability by
...
/-- Under positive shift and positive compact support, the zero-inflated
...
/-- The zero-inflated prior is supported on zero together with the original
...
/-- The first moment of the zero-inflated prior is `a` times the variation
...
/-- The second moment of the zero-inflated prior is at most `B` times its
first moment. -/
...
/-- The finite i.i.d. product of the zero-inflated scalar prior. -/
...
/-- The finite i.i.d. zero-inflated product is a probability measure. -/
...
/-- Every coordinate of the finite i.i.d. prior lies almost surely at zero or
...
/-- Each coordinate of the finite i.i.d. prior has the scalar zero-inflated
first moment. -/
...
/-- Each product coordinate has variance equal to the scalar zero-inflated
variance. -/
...
/-- The sum of all i.i.d. coordinates has expectation `k` times the scalar
first moment. -/
...
/-- Given [a normalized certificate](hyp:C), [positive shift and support-ratio parameters](hyp:a,κ,ha,hκ), [an upper support bound](hyp:B), [a finite product dimension](hyp:k), and [the stated variation-support condition](hyp:hsupp), [the variance of the coordinate sum equals the dimension times the scalar prior variance](goal). -/
