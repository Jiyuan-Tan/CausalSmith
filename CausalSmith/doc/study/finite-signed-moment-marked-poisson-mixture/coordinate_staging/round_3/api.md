...
| `Mathlib.Probability.FiniteMarkovOscillation.nonemptyOfProbabilityVector` | `Causalean.Mathlib.Probability.CertifiedFiniteMarkovExpectation.IsProbabilityVector p → Nonempty S` | Given a finite probability vector on a finite carrier, the carrier is nonempty. |
<!-- /GEN -->
...
| Decl | Signature | Description |
|---|---|---|
| `Mathlib.Probability.CertifiedFiniteMarkovExpectation.CertifiedNormalCDFEnclosure.gaussianIntegralMagnitude` | `ℝ → ℕ → ℝ` | The nonnegative real magnitude of the `k`th integrated Gaussian-series coefficient at a nonnegative argument `x`. |
...
| `Mathlib.Probability.CertifiedFiniteMarkovExpectation.CertifiedNormalCDFEnclosure.millsTailInterval` | `ℚ → Causalean.Mathlib.Analysis.CertifiedContourIntervalArithmetic.RatInterval → Causalean.Mathlib.Analysis.CertifiedContourIntervalArithmetic.RatInterval` | A rational Mills tail enclosure is the hull of the lower-factor product and upper-factor product with the certified density interval. |
...
| `Mathlib.Probability.CertifiedFiniteMarkovExpectation.CertifiedNormalCDFEnclosure.tailInterval` | `(q : ℚ) → Causalean.Mathlib.Probability.CertifiedFiniteMarkovExpectation.CertifiedNormalCDFEnclosure.TailCertificate q → Causalean.Mathlib.Analysis.CertifiedContourIntervalArithmetic.RatInterval` | The signed tail evaluator returns the upper-tail interval directly for a negative endpoint and reflects it for a positive endpoint. |
...
This reusable minimax substrate turns finite normalized signed moment certificates into Jordan and zero-inflated probability priors, then controls aggregate and label-gated marked-Poisson prior-predictive experiments. The final product theorem tensorizes the one-coordinate geometric total-variation estimate.

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.Main -->
_(no documented declarations in Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.Main)_
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.Certificate -->
| Decl | Signature | Description |
|---|---|---|
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate` | `(ι : Type u_1) → [Fintype ι] → ℕ → Type u_1` | The certificate structure is specified using the finite node index set, the moment-matching degree. A normalized finite signed moment certificate consists of distinct real nodes, signed weights of total absolute mass one, and vanishing algebraic moments through degree `L`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.signedMeasure` | `MeasureTheory.SignedMeasure ℝ` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The atomic signed measure represented by a finite signed certificate. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.absoluteMeasure` | `MeasureTheory.Measure ℝ` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The atomic absolute-weight measure associated with a finite signed certificate. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.variation_eq_absoluteMeasure` | `MeasureTheory.VectorMeasure.variation C.signedMeasure = C.absoluteMeasure` | The stated conclusion follows from the finite signed certificate. The signed certificate's vector-measure variation is exactly its atomic absolute-weight measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.signedMeasure_univ_eq_zero` | `C.signedMeasure Set.univ = 0` | The stated conclusion follows from the finite signed certificate. The total signed mass of the certificate is zero, as the degree-zero moment constraint requires. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integral_pow_signedMeasure_eq_zero` | `∀ j ≤ L, ∫ᵛ (x : ℝ), x ^ j ∂<•C.signedMeasure = 0` | The stated conclusion follows from the finite signed certificate, the requested moment degree, the degree condition. Integration against the atomic signed measure recovers every vanishing certificate moment through degree `L`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.variation_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure (MeasureTheory.VectorMeasure.variation C.signedMeasure)` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The variation of a normalized finite signed certificate is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.polarSign` | `ℝ → ℝ` | The defined object is determined by the finite signed certificate, the evaluation point and is given by the following defining expression. The measurable atomic polar sign: it equals the sign of the unique weight at a certificate node and is zero away from all nodes. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.measurable_polarSign` | `Measurable C.polarSign` | The stated conclusion follows from the finite signed certificate. The atomic polar sign is Borel measurable. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.abs_polarSign_ae` | `∀ᵐ (x : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, \|C.polarSign x\| = 1` | The stated conclusion follows from the finite signed certificate. The atomic polar sign has absolute value one almost everywhere for the variation measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integrable_polarSign` | `MeasureTheory.Integrable C.polarSign (MeasureTheory.VectorMeasure.variation C.signedMeasure)` | The stated conclusion follows from the finite signed certificate. The atomic polar sign is integrable against the variation measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.signedMeasure_eq_withDensity_polarSign` | `C.signedMeasure = (MeasureTheory.VectorMeasure.variation C.signedMeasure).withDensityᵥ C.polarSign` | The stated conclusion follows from the finite signed certificate. Polar decomposition of the atomic signed measure: the signed certificate is its variation weighted by the measurable polar sign. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.positivePrior` | `MeasureTheory.Measure ℝ` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The normalized positive Jordan prior, obtained by doubling the positive atomic mass of the signed certificate. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.negativePrior` | `MeasureTheory.Measure ℝ` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The normalized negative Jordan prior, obtained by doubling the negative atomic mass of the signed certificate. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.positivePrior_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure C.positivePrior` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The positive Jordan prior is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.negativePrior_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure C.negativePrior` | The defined object is determined by the finite signed certificate and is given by the following defining expression. The negative Jordan prior is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.jordanDecomposition_posPart_eq` | `C.signedMeasure.toJordanDecomposition.posPart = 2⁻¹ • C.positivePrior` | The stated conclusion follows from the finite signed certificate. The positive part of the signed measure's Jordan decomposition is one half of the normalized positive Jordan prior. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.jordanDecomposition_negPart_eq` | `C.signedMeasure.toJordanDecomposition.negPart = 2⁻¹ • C.negativePrior` | The stated conclusion follows from the finite signed certificate. The negative part of the signed measure's Jordan decomposition is one half of the normalized negative Jordan prior. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.jordanPriors_moments_eq` | `∀ j ≤ L, ∫ (x : ℝ), x ^ j ∂C.positivePrior = ∫ (x : ℝ), x ^ j ∂C.negativePrior` | The stated conclusion follows from the finite signed certificate, the requested moment degree, the degree condition. The two normalized Jordan priors have equal moments through degree `L`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.jordanPriors_ae_mem_range` | `(∀ᵐ (x : ℝ) ∂C.positivePrior, x ∈ Set.range C.node) ∧ ∀ᵐ (x : ℝ) ∂C.negativePrior, x ∈ Set.range C.node` | The stated conclusion follows from the finite signed certificate. The positive and negative priors are concentrated on the finite set of certificate nodes. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.orientedPrior0` | `(ℝ → ℝ) → MeasureTheory.Measure ℝ` | The defined object is determined by the finite signed certificate, the target function and is given by the following defining expression. The null prior oriented for a target `f`; the naming is chosen so that the target mean under prior one is at least that under prior zero. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.orientedPrior1` | `(ℝ → ℝ) → MeasureTheory.Measure ℝ` | The defined object is determined by the finite signed certificate, the target function and is given by the following defining expression. The alternative prior oriented for a target `f`; it swaps the Jordan priors exactly when the certificate evaluates `f` negatively. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.orientedPrior0_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure (C.orientedPrior0 f)` | The defined object is determined by the finite signed certificate, the target function and is given by the following defining expression. The target-oriented null prior is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.orientedPrior1_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure (C.orientedPrior1 f)` | The defined object is determined by the finite signed certificate, the target function and is given by the following defining expression. The target-oriented alternative prior is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.orientedPrior_target_separation` | `∫ (x : ℝ), f x ∂C.orientedPrior1 f - ∫ (x : ℝ), f x ∂C.orientedPrior0 f = 2 * \|∑ i, C.weight i * f (C.node i)\|` | The stated conclusion follows from the finite signed certificate, the target function. Target orientation turns the signed evaluation into the exact nonnegative difference of target expectations under the two Jordan priors. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.orientedPriors_moments_eq` | `∀ j ≤ L, ∫ (x : ℝ), x ^ j ∂C.orientedPrior0 f = ∫ (x : ℝ), x ^ j ∂C.orientedPrior1 f` | The stated conclusion follows from the finite signed certificate, the target function, the requested moment degree, the degree condition. The target-oriented Jordan priors retain equal moments through degree `L`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.ofFiniteMomentDual` | `Causalean.Mathlib.Analysis.FinitePolynomialAlternationDuality.FiniteMomentDual f r s L → Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate (Fin (L + 2)) L` | The defined object is determined by the target function, the lower endpoint, the upper endpoint, the alternation dual certificate and is given by the following defining expression. An existing finite alternation moment dual canonically supplies a normalized finite signed moment certificate. |
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.ZeroInflated -->
| Decl | Signature | Description |
|---|---|---|
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.zeroInflatedPrior` | `ℝ → MeasureTheory.Measure ℝ` | The defined object is determined by the finite signed certificate, the positive shift and is given by the following defining expression. The zero-inflated prior obtained by weighting the variation probability by `a / (p + a)` and assigning the residual probability to zero. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.zeroInflatedPrior_isProbabilityMeasure` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → MeasureTheory.IsProbabilityMeasure (C.zeroInflatedPrior a)` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, positive shift, the support-ratio identity, the compact-support condition. Under positive shift and positive compact support, the zero-inflated construction is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.zeroInflatedPrior_support` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∀ᵐ (p : ℝ) ∂C.zeroInflatedPrior a, p = 0 ∨ p ∈ Set.Icc (a / κ) B` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, positive shift, the support-ratio identity, the compact-support condition. The zero-inflated prior is supported on zero together with the original compact support interval. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integral_id_zeroInflatedPrior` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∫ (p : ℝ), p ∂C.zeroInflatedPrior a = a * ∫ (p : ℝ), p / (p + a) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, positive shift, the support-ratio identity, the compact-support condition. The first moment of the zero-inflated prior is `a` times the variation expectation of `p / (p + a)`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integral_sq_zeroInflatedPrior_le` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∫ (p : ℝ), p ^ 2 ∂C.zeroInflatedPrior a ≤ B * ∫ (p : ℝ), p ∂C.zeroInflatedPrior a` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, positive shift, the support-ratio identity, the compact-support condition. The second moment of the zero-inflated prior is at most `B` times its first moment. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.zeroInflatedProductPrior` | `ℝ → (k : ℕ) → MeasureTheory.Measure (Fin k → ℝ)` | The defined object is determined by the finite signed certificate, the positive shift, the number of independent coordinates and is given by the following defining expression. The finite i.i.d. product of the zero-inflated scalar prior. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.zeroInflatedProductPrior_isProbabilityMeasure` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → MeasureTheory.IsProbabilityMeasure (C.zeroInflatedProductPrior a k)` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, positive shift, the support-ratio identity, the compact-support condition. The finite i.i.d. zero-inflated product is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.zeroInflatedProductPrior_support` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∀ᵐ (w : Fin k → ℝ) ∂C.zeroInflatedProductPrior a k, ∀ (i : Fin k), w i = 0 ∨ w i ∈ Set.Icc (a / κ) B` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, positive shift, the support-ratio identity, the compact-support condition. Every coordinate of the finite i.i.d. prior lies almost surely at zero or in the original compact interval. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integral_coordinate_zeroInflatedProductPrior` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∫ (w : Fin k → ℝ), w i ∂C.zeroInflatedProductPrior a k = a * ∫ (p : ℝ), p / (p + a) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, the coordinate index, positive shift, the support-ratio identity, the compact-support condition. Each coordinate of the finite i.i.d. prior has the scalar zero-inflated first moment. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integral_coordinate_sq_zeroInflatedProductPrior` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∫ (w : Fin k → ℝ), w i ^ 2 ∂C.zeroInflatedProductPrior a k = ∫ (p : ℝ), p ^ 2 ∂C.zeroInflatedPrior a` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, the coordinate index, positive shift, the support-ratio identity, the compact-support condition. Each coordinate of the finite i.i.d. prior has the scalar zero-inflated second moment. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.variance_coordinate_zeroInflatedProductPrior` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ProbabilityTheory.variance (fun w => w i) (C.zeroInflatedProductPrior a k) = ProbabilityTheory.variance id (C.zeroInflatedPrior a)` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, the coordinate index, positive shift, the support-ratio identity, the compact-support condition, the coordinate weight. Each product coordinate has variance equal to the scalar zero-inflated variance. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.integral_sum_zeroInflatedProductPrior` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ∫ (w : Fin k → ℝ), ∑ i, w i ∂C.zeroInflatedProductPrior a k = ↑k * (a * ∫ (p : ℝ), p / (p + a) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure)` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, positive shift, the support-ratio identity, the compact-support condition. The sum of all i.i.d. coordinates has expectation `k` times the scalar first moment. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.variance_sum_zeroInflatedProductPrior` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → ProbabilityTheory.variance (fun w => ∑ i, w i) (C.zeroInflatedProductPrior a k) = ↑k * ProbabilityTheory.variance id (C.zeroInflatedPrior a)` | The stated conclusion follows from the finite signed certificate, the positive shift, the support ratio, the support upper bound, the number of independent coordinates, positive shift, the support-ratio identity, the compact-support condition, the coordinate weight. The variance of the sum of the finite i.i.d. coordinates is `k` times the scalar variance. |
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoisson -->
| Decl | Signature | Description |
|---|---|---|
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoissonObservation` | `Type` | The defined object is determined by the displayed assumptions and is given by the following defining expression. The two-count observation consisting of aggregate treated and aggregate control counts. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregateTreatedRate` | `ℝ → ℝ → ℝ → ℝ → ℝ` | The defined object is determined by the overlap fraction, the positive shift, the aggregate intensity, the latent mass and is given by the following defining expression. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregateControlRate` | `ℝ → ℝ → ℝ → ℝ → ℝ` | The defined object is determined by the overlap fraction, the positive shift, the aggregate intensity, the latent mass and is given by the following defining expression. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonLaw` | `ℝ → ℝ → ℝ → ℝ → MeasureTheory.Measure Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoissonObservation` | The defined object is determined by the overlap fraction, the positive shift, the aggregate intensity, the latent mass and is given by the following defining expression. The explicit pair of independent Poisson laws with aggregate treated and control rates. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonLaw_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonLaw ε a t p)` | The defined object is determined by the overlap fraction, the positive shift, the aggregate intensity, the latent mass and is given by the following defining expression. Every aggregate two-count law is a probability measure. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonKernel` | `ℝ → ℝ → ℝ → ProbabilityTheory.Kernel ℝ Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoissonObservation` | The defined object is determined by the overlap fraction, the positive shift, the aggregate intensity and is given by the following defining expression. The aggregate affine-Poisson experiment as a kernel from latent mass to the treated/control count pair. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonKernel_apply` | `(Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonKernel ε a t) p = Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonLaw ε a t p` | The stated conclusion follows from the overlap fraction, the positive shift, the aggregate intensity, the latent mass. The aggregate kernel fibre is the explicit product-Poisson law. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive` | `MeasureTheory.Measure ℝ → ℝ → ℝ → ℝ → MeasureTheory.Measure Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoissonObservation` | The defined object is determined by the latent prior, the overlap fraction, the positive shift, the aggregate intensity and is given by the following defining expression. Mixing the aggregate affine-Poisson kernel against a latent prior gives its prior-predictive treated/control count law. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.exists_geometric_sqrt_exponentialSeriesTail_bound` | `0 < A → ∃ b D ρ, 0 < b ∧ 0 < D ∧ ρ ∈ Set.Ioo 0 1 ∧ ∀ (L : ℕ) (x : ℝ), 0 ≤ x → x ≤ b * ↑L → √(Causalean.Stat.Minimax.MomentMatchedMixture.exponentialSeriesTail L (A * x)) ≤ D * ρ ^ L` | The stated conclusion follows from the tail-scale constant, positive tail-scale constant, the moment-matching degree, the evaluation point. A square root of an exponential-series tail is uniformly geometric in the matching degree when its argument is at most a sufficiently small fixed multiple of that degree. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.exists_aggregatePoisson_jordan_sqrt_tail_bound` | `0 < ε → ε < 1 / 2 → κ = (1 - 2 * ε) / ε → ∃ A, 0 < A ∧ ∀ {ι : Type u_1} [inst : Fintype ι] {L : ℕ} (C : Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate ι L) (a B t : ℝ), 0 < a → 0 < B → 0 < t → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → Causalean.Stat.tvDist (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive C.positivePrior ε a t) (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive C.negativePrior ε a t) ≤ √(Causalean.Stat.Minimax.MomentMatchedMixture.exponentialSeriesTail L (A * (t * B)))` | The stated conclusion follows from the overlap fraction, the support ratio, positive overlap fraction, the overlap upper bound, the support-ratio identity, the finite node index set, the moment-matching degree, the finite signed certificate, the positive shift, the support upper bound, the aggregate intensity. For fixed overlap geometry, the aggregate affine-Poisson mixtures of the positive and negative Jordan priors satisfy a square-root exponential-tail TV bound with argument proportional to `t * B`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.exists_geometric_aggregatePoisson_jordan_tv_bound` | `0 < ε → ε < 1 / 2 → κ = (1 - 2 * ε) / ε → ∃ b D ρ, 0 < b ∧ 0 < D ∧ ρ ∈ Set.Ioo 0 1 ∧ ∀ {ι : Type u_1} [inst : Fintype ι] {L : ℕ} (C : Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate ι L) (a B t : ℝ), 0 < a → 0 < B → 0 < t → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → t * B ≤ b * ↑L → Causalean.Stat.tvDist (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive C.positivePrior ε a t) (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive C.negativePrior ε a t) ≤ D * ρ ^ L` | The stated conclusion follows from the overlap fraction, the support ratio, positive overlap fraction, the overlap upper bound, the support-ratio identity, the finite node index set, the moment-matching degree, the finite signed certificate, the positive shift, the support upper bound, the aggregate intensity. For fixed overlap geometry, moment matching makes the two aggregate Jordan-prior predictive laws geometrically close whenever `t * B` is at most a sufficiently small multiple of the matching degree. |
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoisson -->
| Decl | Signature | Description |
|---|---|---|
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoissonObservation` | `Type` | The defined object is determined by the displayed assumptions and is given by the following defining expression. One coordinate of the marked-Poisson experiment: labeled treated counts with marks one and zero, followed by auxiliary-treated and aggregate-control counts. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.treatedMass` | `ℝ → ℝ → ℝ → ℝ` | The defined object is determined by the overlap fraction, the positive shift, the latent mass and is given by the following defining expression. The treated mass attached to latent mass `p`, overlap level `ε`, and shift `a`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.controlMass` | `ℝ → ℝ → ℝ → ℝ` | The defined object is determined by the overlap fraction, the positive shift, the latent mass and is given by the following defining expression. The aggregate control mass left after subtracting the treated mass from the latent cell mass. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.branchMark` | `Bool → ℝ → ℝ` | The defined object is determined by the outcome-mark branch, the outcome-mark function and is given by the following defining expression. The signed outcome mark for a branch: the alternative uses `h`, while the null uses `-h`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonLaw` | `ℝ → ℝ → ℝ → ℝ → (ℝ → ℝ) → Bool → ℝ → MeasureTheory.Measure Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoissonObservation` | The defined object is determined by the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the outcome-mark function, the outcome-mark branch, the latent mass and is given by the following defining expression. The explicit law of the four independent Poisson counts at latent `p`. Real rates are converted to nonnegative rates by `Real.toNNReal`; the main theorems' support assumptions ensure the intended rates are already nonnegative. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonLaw_isProbabilityMeasure` | `MeasureTheory.IsProbabilityMeasure (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonLaw ε a u v h branch p)` | The defined object is determined by the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the outcome-mark function, the outcome-mark branch, the latent mass and is given by the following defining expression. The marked-Poisson law is a probability measure for every parameter. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonKernel` | `ℝ → ℝ → ℝ → ℝ → (h : ℝ → ℝ) → Measurable h → Bool → ProbabilityTheory.Kernel ℝ Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoissonObservation` | The defined object is determined by the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the outcome-mark function, measurability of the mark function, the outcome-mark branch and is given by the following defining expression. The four-count experiment as a probability kernel from the latent real mass to marked-Poisson observations. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonKernel_apply` | `(Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonKernel ε a u v h hh branch) p = Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.markedPoissonLaw ε a u v h branch p` | The stated conclusion follows from the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the outcome-mark function, measurability of the mark function, the outcome-mark branch, the latent mass. The marked-Poisson kernel's fibre is the explicit four-count law. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.markedPoissonPredictive` | `ℝ → ℝ → ℝ → ℝ → Bool → MeasureTheory.Measure Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoissonObservation` | The defined object is determined by the finite node index set, the moment-matching degree, the finite signed certificate, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the outcome-mark branch and is given by the following defining expression. The one-coordinate prior-predictive marked-Poisson law obtained by mixing the zero-inflated variation prior over the latent mass. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.markedPoissonPredictive_isProbabilityMeasure` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → MeasureTheory.IsProbabilityMeasure (C.markedPoissonPredictive ε a u v branch)` | The stated conclusion follows from the finite node index set, the moment-matching degree, the finite signed certificate, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the support ratio, the support upper bound, the outcome-mark branch, positive shift, the support-ratio identity, the compact-support condition. The one-coordinate marked-Poisson predictive law is a probability measure under the support assumptions that normalize the zero-inflated prior. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.noLabeledTreated` | `Set Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoissonObservation` | The defined object is determined by the displayed assumptions and is given by the following defining expression. The event that no labeled treated observation appears in either outcome mark. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.measurableSet_noLabeledTreated` | `MeasurableSet Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.noLabeledTreated` | The stated conclusion follows from the displayed assumptions. The no-labeled-treated event is measurable. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.restrict_markedPoissonPredictive_noLabeledTreated_eq` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → (C.markedPoissonPredictive ε a u v false).restrict Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.noLabeledTreated = (C.markedPoissonPredictive ε a u v true).restrict Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.noLabeledTreated` | The stated conclusion follows from the finite node index set, the moment-matching degree, the finite signed certificate, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the support ratio, the support upper bound, positive shift, the support-ratio identity, the compact-support condition. On the zero-labeled-count event, the two prior-predictive laws agree exactly; the auxiliary treated and aggregate control counts are branch invariant. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.tvDist_markedPoissonPredictive_le_palm_aggregate` | `0 < ε → ε < 1 / 2 → κ = (1 - 2 * ε) / ε → 0 < a → 0 < B → 0 ≤ u → 0 ≤ v → 0 < u + v → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → Causalean.Stat.tvDist (C.markedPoissonPredictive ε a u v false) (C.markedPoissonPredictive ε a u v true) ≤ u * ε * a * Causalean.Stat.tvDist (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive C.positivePrior ε a (u + v)) (Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.aggregatePoissonPredictive C.negativePrior ε a (u + v))` | The stated conclusion follows from the finite node index set, the moment-matching degree, the finite signed certificate, the overlap fraction, the support ratio, the positive shift, the support upper bound, the labeled treated intensity, the auxiliary treated intensity, positive overlap fraction, the overlap upper bound, the support-ratio identity, positive shift, positive upper bound, nonnegative labeled intensity, nonnegative auxiliary intensity, positive total intensity, the compact-support condition. The marked-law discrepancy is at most the labeled Palm intensity `u * ε * a` times the discrepancy between aggregate treated/control mixtures of the two Jordan priors. The result includes `u = 0` and `v = 0`; only the total intensity must be positive. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.exists_geometric_markedPoisson_tv_bound` | `0 < ε → ε < 1 / 2 → κ = (1 - 2 * ε) / ε → ∃ b C₀ ρ, 0 < b ∧ 0 < C₀ ∧ ρ ∈ Set.Ioo 0 1 ∧ ∀ {ι : Type u_1} [inst : Fintype ι] {L : ℕ} (C : Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate ι L) (a B u v : ℝ), 0 < a → 0 < B → 0 ≤ u → 0 ≤ v → 0 < u + v → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → (u + v) * B ≤ b * ↑L → Causalean.Stat.tvDist (C.markedPoissonPredictive ε a u v false) (C.markedPoissonPredictive ε a u v true) ≤ C₀ * u * a * ρ ^ L` | The stated conclusion follows from the overlap fraction, the support ratio, positive overlap fraction, the overlap upper bound, the support-ratio identity, the finite node index set, the moment-matching degree, the finite signed certificate, the positive shift, the support upper bound, the labeled treated intensity, the auxiliary treated intensity. For fixed overlap and support-ratio parameters there are positive constants `b,C₀` and a geometric factor `ρ < 1` such that moment matching through `L` bounds one-coordinate marked-Poisson TV by `C₀ * u * a * ρ^L` whenever `(u+v)B ≤ bL`. The statement includes the edge cases `u = 0` and `v = 0` as long as total intensity is positive. |
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.Product -->
| Decl | Signature | Description |
|---|---|---|
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.markedPoissonProductPredictive` | `(k : ℕ) → ℝ → ℝ → ℝ → ℝ → Bool → MeasureTheory.Measure (Fin k → Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoissonObservation)` | The defined object is determined by the finite signed certificate, the number of independent coordinates, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the outcome-mark branch and is given by the following defining expression. The `k`-fold i.i.d. product of a one-coordinate marked-Poisson predictive law. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.markedPoissonProductPredictive_isProbabilityMeasure` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → MeasureTheory.IsProbabilityMeasure (C.markedPoissonProductPredictive k ε a u v branch)` | The stated conclusion follows from the finite signed certificate, the number of independent coordinates, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the support ratio, the support upper bound, the outcome-mark branch, positive shift, the support-ratio identity, the compact-support condition. The i.i.d. product marked-Poisson predictive law is a probability measure under the scalar prior's support assumptions. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.tvDist_markedPoissonProductPredictive_le` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → Causalean.Stat.tvDist (C.markedPoissonPredictive ε a u v false) (C.markedPoissonPredictive ε a u v true) ≤ δ → Causalean.Stat.tvDist (C.markedPoissonProductPredictive k ε a u v false) (C.markedPoissonProductPredictive k ε a u v true) ≤ ↑k * δ` | The stated conclusion follows from the finite signed certificate, the number of independent coordinates, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the support ratio, the support upper bound, the one-coordinate distance bound, positive shift, the support-ratio identity, the compact-support condition, the one-coordinate TV bound. A one-coordinate TV estimate tensorizes to `k` independent coordinates by `tvDist_pi_iid_le`. |
| `Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.NormalizedFiniteSignedMomentCertificate.markedPoissonProductPredictive_geometric_tv_le` | `0 < a → 0 < κ → (∀ᵐ (p : ℝ) ∂MeasureTheory.VectorMeasure.variation C.signedMeasure, p ∈ Set.Icc (a / κ) B) → Causalean.Stat.tvDist (C.markedPoissonPredictive ε a u v false) (C.markedPoissonPredictive ε a u v true) ≤ C₀ * u * a * ρ ^ L → Causalean.Stat.tvDist (C.markedPoissonProductPredictive k ε a u v false) (C.markedPoissonProductPredictive k ε a u v true) ≤ C₀ * u * ↑k * a * ρ ^ L` | The stated conclusion follows from the finite signed certificate, the number of independent coordinates, the overlap fraction, the positive shift, the labeled treated intensity, the auxiliary treated intensity, the support ratio, the support upper bound, the geometric-bound constant, the geometric decay factor, positive shift, the support-ratio identity, the compact-support condition, the one-coordinate TV bound. The geometric one-coordinate estimate composes with finite i.i.d. products, giving `k` times the one-coordinate bound. |
<!-- /GEN -->
