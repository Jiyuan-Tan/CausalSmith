...
This reusable minimax substrate converts normalized finite signed moment certificates into Jordan and zero-inflated priors, then controls label-gated marked-Poisson experiments and their finite independent products.
...
<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoisson.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoisson.Analytic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.AggregatePoisson.Jordan -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoisson.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoisson.Palm -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoisson.Bound -->
<!-- /GEN -->
...
<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoisson.Palm.Decomposition -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Minimax.MomentMatchedMixture.FiniteSignedMomentMarkedPoissonMixture.MarkedPoisson.Palm.Certificate -->
<!-- /GEN -->
