...
### Positive finite-DAG mechanisms

Strictly positive factorization interfaces characterize an edge as redundant precisely when its
child's local conditional density ignores the parent. Nonzero four-point contrasts provide finite
witnesses of nonredundancy that remain valid under uniform factor perturbations.

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.Edge -->
<!-- /GEN -->

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.Witness -->
<!-- /GEN -->

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.Finite -->
<!-- /GEN -->

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.FiniteWitness -->
<!-- /GEN -->

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.Examples -->
<!-- /GEN -->

<!-- GEN:Causalean.Graph.FiniteDensity.Positive.Main -->
<!-- /GEN -->
...
## 10a''''''''. `Mathlib/Analysis/LogRatioStability.lean` — log-ratio derivative stability

Positive functions with one common lower bound retain a fixed, strictly signed log-ratio
derivative under sufficiently small uniform C¹ perturbations; uniform C² control is included by
restriction. This scalar analytic interface is independent of the DAG applications.

<!-- GEN:Causalean.Mathlib.Analysis.LogRatioStability -->
<!-- /GEN -->
