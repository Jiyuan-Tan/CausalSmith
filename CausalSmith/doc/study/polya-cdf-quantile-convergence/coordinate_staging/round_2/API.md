...
These deterministic results turn weak convergence to a continuous limit law into uniform CDF
control, and then turn that control into convergence of interior quantiles.  They provide the
probability-law interface used by bootstrap and quantile-based confidence procedures.

<!-- GEN:Causalean.Stat.Quantile.CdfConvergence -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Quantile.Convergence -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Quantile.GaussianQuantile -->
<!-- /GEN -->
