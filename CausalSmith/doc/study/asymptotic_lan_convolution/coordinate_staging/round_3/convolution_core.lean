import Causalean.Estimation.Efficiency.AsymptoticLanConvolution.ExponentialTilt
import Causalean.Estimation.Efficiency.AsymptoticLanConvolution.LikelihoodNormalization
...
/-- Two measurable row-indexed statistics with weakly convergent probability marginals admit a
...
/-- Le Cam's change-of-measure step along a chosen joint weak subsequence.  After normalization
of the likelihood ratios, every bounded scalar characteristic function under a fixed local law
converges to its exponentially tilted joint-limit integral. -/
