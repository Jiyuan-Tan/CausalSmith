...
### Efficiency/AsymptoticLanConvolution/

Local asymptotic normality and scalar convolution results for semiparametric efficiency: a general local-experiment interface, an i.i.d. quadratic-mean differentiability route to LAN, and the regular-estimator variance lower bound.

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.TriangularArray -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.LogTaylor -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.IIDDQM -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.IIDDQMLAN -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.ExponentialTilt -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.LikelihoodNormalization -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.ConvolutionCore -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.Convolution -->
<!-- /GEN -->

<!-- GEN:Causalean.Estimation.Efficiency.AsymptoticLanConvolution.Variance -->
<!-- /GEN -->
## Panel/
