...
`a, b` of `xs`.  A final unpaired entry contributes no factor. [the stated inputs](hyp:t) establish [the defined object](goal). -/
...
product after adding the same nonnegative constant to each pair. [the stated inputs](hyp:a,b,c,d,t,ht,hab,hbc,hcd) establish [the stated conclusion](goal). -/
...
at most the consecutive-pair product of `xs` itself. [the stated inputs](hyp:t,ht,xs,ys,heven,hsorted,hnonneg,hperm) establish [the stated conclusion](goal). -/
