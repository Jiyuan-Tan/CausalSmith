...
import Causalean.Mathlib.Analysis.FinitePolynomialAlternationDuality.ExtremalPerturbation
import Causalean.Mathlib.Analysis.FinitePolynomialAlternationDuality.ExtremalSignPolynomial
...
magnitude with alternating signs. [the stated inputs](hyp:f,r,s,L) establish the described certificate. -/
...
ordered interval points. [the stated inputs](hyp:f,r,s,hrs,hf,L) establish [the stated conclusion](goal). -/
