...
import Causalean.Mathlib.CondIndep.PositiveDensityIntersection.ThreeBlockFactorization
...
/-- [Four sigma-finite reference measures](hyp:μX,μY,μV,μZ) and [a measurable density](hyp:hd)
[make conditional independence of the first and second blocks given the fourth-and-third pair
equivalent to its corresponding product factorization](goal). -/
...
/-- [Four sigma-finite reference measures](hyp:μX,μY,μV,μZ) and [a measurable density](hyp:hd)
[make conditional independence of the first and third blocks given the fourth-and-second pair
equivalent to its corresponding product factorization](goal). -/
...
/-- [Four sigma-finite reference measures](hyp:μX,μY,μV,μZ) and [a measurable density](hyp:hd)
[make conditional independence of the first block from the joint second-and-third block given the
fourth equivalent to its corresponding product factorization](goal). -/
