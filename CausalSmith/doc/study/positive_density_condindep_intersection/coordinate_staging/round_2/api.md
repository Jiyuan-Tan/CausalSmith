...
A graph-independent intersection rule for conditional independence.  It turns two
relations whose conditioning blocks differ into a joint-block relation when the law
has a strictly positive density relative to a product reference measure; the final
module transports that rule to disjoint finite coordinate blocks.
