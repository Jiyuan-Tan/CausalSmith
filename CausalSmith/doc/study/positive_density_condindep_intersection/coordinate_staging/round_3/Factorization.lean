...
/-- For [four product reference measures](hyp:μX,μY,μV,μZ) and [a measurable density](hyp:hd),
[conditional independence of the first and second blocks given the fourth and third is equivalent
to the corresponding measurable density factorization](goal). -/
