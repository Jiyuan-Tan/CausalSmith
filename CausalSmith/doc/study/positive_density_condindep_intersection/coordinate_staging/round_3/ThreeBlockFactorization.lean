...
/-- For a measurable finite density, conditional product factorization is equivalent to the
cross-multiplied identity involving its three marginal densities. -/
...
/-- For [three reference measures](hyp:muA,muB,muC) and [a measurable finite three-block density](hyp:hd),
