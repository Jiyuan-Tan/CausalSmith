...
## 10a'''''''''. `Mathlib/CondIndep/PositiveDensityIntersection/` — positive-density graphoid intersection

This graph-independent API upgrades conditional independence to the graphoid intersection rule
when a finite joint law has a strictly positive density relative to a product reference measure.
The finite-coordinate theorem makes every pairwise-disjointness condition explicit, so it cannot
silently reuse a coordinate in a conditioning block.

### Product-coordinate and factorization support

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.ThreeBlockMarginals -->
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.ThreeBlockFactorization -->
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.Splice -->
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.Factorization -->
<!-- /GEN -->

### Public intersection results

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.Main -->
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection.FiniteCoordinates -->
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.CondIndep.PositiveDensityIntersection -->
<!-- /GEN -->
