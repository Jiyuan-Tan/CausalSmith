...
The Efron bootstrap treats the observed finite sample as an empirical distribution and draws a
same-size product sample with replacement.  The API provides the atomic finite representation,
exact mean identities, a bridge to the existing plug-in variance, and measurable bootstrap
cumulative distribution functions and lower quantiles.

<!-- GEN:Causalean.Stat.Bootstrap.Efron -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronFiniteRepresentation -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronMoments -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronMeasurability -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronIIDSampleLink -->
<!-- /GEN -->
