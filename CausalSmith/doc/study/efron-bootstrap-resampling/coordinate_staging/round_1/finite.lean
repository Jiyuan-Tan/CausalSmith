...
/-- For [a data vector](hyp:x) and [a measurable real function of a resample](hyp:hf), [its
bootstrap expectation is the ordinary average over all index resamples](goal). -/
