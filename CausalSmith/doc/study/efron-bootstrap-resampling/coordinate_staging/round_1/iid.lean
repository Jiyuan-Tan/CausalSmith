...
sample size with nonzero length](hyp:n,hn), and [an outcome](hyp:ω), [the variance of the
statistic under the empirical measure of the first observations equals the library's plug-in
