...
/-- The vector of design values obtained by applying a one-observation design map to every
coordinate of a finite sample. -/
...
/-- The finite-sample sum of outcome residuals, with each residual weighted by a function of
the complete vector of observed designs. -/
