...
### Bootstrap OLS conditions

For random-design OLS, integrable raw moments and a positive-definite population Gram matrix
make the pairs-bootstrap coefficient consistent and its resample normal equations valid. The
resulting contrast theorem and percentile interval corollary require no bootstrap-side premises.
