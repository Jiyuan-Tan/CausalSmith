...
These compile-time examples exercise conditional-independence transport for the identity
equivalence and for the nontrivial equivalence that swaps the coordinates of a product sample
space.
-/
