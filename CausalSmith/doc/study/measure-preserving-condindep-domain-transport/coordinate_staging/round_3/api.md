...
### `Mathlib/CondIndep/DomainTransport/CondExp.lean`

Conditional expectations and conditional probabilities commute with a measure-preserving
reparameterization when the conditioning information is pulled back with the sample domain.

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.CondExp -->
<!-- /GEN -->

### `Mathlib/CondIndep/DomainTransport/CondIndep.lean`

Conditional independence is invariant under a measure-preserving measurable equivalence when all
three relevant σ-algebras are transported to the new sample domain.

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.CondIndep -->
<!-- /GEN -->

### `Mathlib/CondIndep/DomainTransport/WithDensity.lean`

Weighting a reference measure and transporting it through a measure-preserving equivalence commute.

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.WithDensity -->
<!-- /GEN -->

### `Mathlib/CondIndep/DomainTransport/Examples.lean`

Compile-time identity and coordinate-swap examples exercise the generic sample-domain transport API.

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.Examples -->
<!-- /GEN -->
