...
### `Mathlib/CondIndep/DomainTransport.lean`

Measure-preserving measurable equivalences can identify a coordinate model, a subtype model, or a
chart with an ambient sample space without changing conditional-independence claims.  This module
also transports the corresponding weighted measures, while explicitly pulling the conditioning
information back to the source domain.

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport -->
<!-- /GEN -->

#### `DomainTransport/CondExp.lean`

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.CondExp -->
<!-- /GEN -->

#### `DomainTransport/CondIndep.lean`

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.CondIndep -->
<!-- /GEN -->

#### `DomainTransport/WithDensity.lean`

<!-- GEN:Causalean.Mathlib.CondIndep.DomainTransport.WithDensity -->
<!-- /GEN -->

#### `DomainTransport/Examples.lean`

The identity and product-coordinate-swap examples give ready-to-check specializations of the
sample-domain transport API.
