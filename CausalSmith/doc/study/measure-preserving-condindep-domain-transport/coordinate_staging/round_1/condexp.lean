...
measurable target event](hyp:s,hs), [the conditional probability of its preimage under the pulled
back conditioning information is the pulled-back target conditional probability almost everywhere](goal). -/
