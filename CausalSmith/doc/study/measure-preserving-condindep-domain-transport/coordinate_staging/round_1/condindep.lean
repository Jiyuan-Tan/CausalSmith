...
/-- With [a measure-preserving measurable equivalence of finite standard-Borel sample spaces](hyp:e,he)
and [three target-domain σ-algebras contained in the target ambient σ-algebra](hyp:mX,mY,mZ,hX,hY,hZ),
...
/-- With [a measure-preserving measurable equivalence of finite standard-Borel sample spaces](hyp:e,he)
and [three measurable target-domain random variables](hyp:X,Y,Z,hX,hY,hZ), [conditional
