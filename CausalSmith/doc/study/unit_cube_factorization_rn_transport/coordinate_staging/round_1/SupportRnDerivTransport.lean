...
[measurable source and target supports](hyp:S,T,hS,hT), [concentration on the source support]
(hyp:hμS,hνS), and [forward and reverse maps measurable on their supports](hyp:f,g,hf,hg), whose
