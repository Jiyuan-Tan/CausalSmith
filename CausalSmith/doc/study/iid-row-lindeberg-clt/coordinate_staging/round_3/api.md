...
### Lindeberg--Feller row CLT

This reusable triangular-array CLT covers rows whose iid law changes with the row index.  Its
normalized form is the natural limit theorem for bootstrap sample means conditional on fixed data.

<!-- GEN:Causalean.Stat.CLT.Lindeberg -->
<!-- /GEN -->
