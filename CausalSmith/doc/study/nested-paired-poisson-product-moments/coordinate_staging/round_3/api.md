...
The nested paired-count companion flattens a finite array of independent count pairs into a single Poisson product, then supplies polynomial-growth L² premises and coordinate-product moment identities for downstream Poincaré-energy calculations.

<!-- GEN:Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.Flattening -->
| Decl | Signature | Description |
|---|---|---
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.NestedPairedPoissonIndex` | `Type u_1 → Type u_2 → Type (max u_1 u_2)` | Two finite index types determine the coordinate labels for a flattened nested paired-count array, given by a cell label together with a tag for its first or second count. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonRates` | `(iota → kappa → NNReal) → (iota → kappa → NNReal) → Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.NestedPairedPoissonIndex iota kappa → NNReal` | Two arrays of nonnegative Poisson rates determine the rate assigned to each flattened coordinate, given by selecting the first or second rate according to that coordinate's count tag. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.measurePreserving_piCurry_probability` | `MeasureTheory.MeasurePreserving (⇑(MeasurableEquiv.piCurry X)) (MeasureTheory.Measure.pi fun p => mu p.fst p.snd) (MeasureTheory.Measure.pi fun i => MeasureTheory.Measure.pi (mu i))` | A finite family of probability laws has the same product law after regrouping a dependent pair of finite indices. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.measurePreserving_piCongrRight_probability` | `(∀ (i : alpha), MeasureTheory.MeasurePreserving (⇑(e i)) (mu i) (nu i)) → MeasureTheory.MeasurePreserving (⇑(MeasurableEquiv.piCongrRight e)) (MeasureTheory.Measure.pi mu) (MeasureTheory.Measure.pi nu)` | Two finite families of probability laws, coordinatewise measurable equivalences, and the fact that they preserve their corresponding laws transport one finite product probability law to the other. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening` | `(iota : Type u_1) → (kappa : Type u_2) → [Fintype iota] → [Fintype kappa] → (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.NestedPairedPoissonIndex iota kappa → ℕ) ≃ᵐ (iota → kappa → ℕ × ℕ)` | Two finite index types determine a measurable equivalence from a flat count vector to a nested array of count pairs, given by currying the two index levels and grouping the two tagged counts in each cell. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonFlattening` | `(iota : Type u_1) → (kappa : Type u_2) → [Fintype iota] → [Fintype kappa] → (iota → kappa → ℕ × ℕ) ≃ᵐ (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.NestedPairedPoissonIndex iota kappa → ℕ)` | Two finite index types determine a measurable equivalence from a nested array of count pairs to one flat count vector, given by the inverse of the canonical unflattening equivalence. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening_apply` | `(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i j = (z ⟨i, ⟨j, 0⟩⟩, z ⟨i, ⟨j, 1⟩⟩)` | A flat count vector and selected nested-array cell have an unflattened count pair equal to the two tagged flat counts. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonFlattening_apply_zero` | `(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonFlattening iota kappa) x ⟨i, ⟨j, 0⟩⟩ = (x i j).1` | A nested count-pair array and selected cell have a first-tag flattened coordinate equal to that cell's first count. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonFlattening_apply_one` | `(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonFlattening iota kappa) x ⟨i, ⟨j, 1⟩⟩ = (x i j).2` | A nested count-pair array and selected cell have a second-tag flattened coordinate equal to that cell's second count. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.measurePreserving_nestedPairedPoissonUnflattening` | `MeasureTheory.MeasurePreserving (⇑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa)) (Causalean.Mathlib.Probability.PoissonAddOnePoincare.poissonPi (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonRates lambda₁ lambda₂)) (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates have a flat independent-Poisson product law transported to their nested paired-count law. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.measurePreserving_nestedPairedPoissonFlattening` | `MeasureTheory.MeasurePreserving (⇑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonFlattening iota kappa)) (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂) (Causalean.Mathlib.Probability.PoissonAddOnePoincare.poissonPi (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonRates lambda₁ lambda₂))` | Two arrays of nonnegative Poisson rates have their nested paired-count law transported to the corresponding flat independent-Poisson product law. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening_update_fst` | `(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) (Function.update z ⟨i, ⟨j, 0⟩⟩ (z ⟨i, ⟨j, 0⟩⟩ + 1)) = Function.update ((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z) i (Function.update ((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i) j (((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i j).1 + 1, ((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i j).2))` | A flat count vector and selected nested-array cell have a first-tag increment that unflattens to adding one to that cell's first count. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening_update_snd` | `(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) (Function.update z ⟨i, ⟨j, 1⟩⟩ (z ⟨i, ⟨j, 1⟩⟩ + 1)) = Function.update ((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z) i (Function.update ((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i) j (((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i j).1, ((Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonUnflattening iota kappa) z i j).2 + 1))` | A flat count vector and selected nested-array cell have a second-tag increment that unflattens to adding one to that cell's second count. |
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.PolynomialGrowth -->
| Decl | Signature | Description |
|---|---|---
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedTotalCount` | `(iota → kappa → ℕ × ℕ) → ℕ` | A nested array of count pairs determines its total count, given by summing both counts across every finite array cell. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.integrable_natCast_pow_poissonMeasure` | `MeasureTheory.Integrable (fun n => ↑n ^ degree) (ProbabilityTheory.poissonMeasure lambda)` | A nonnegative Poisson rate and natural-number exponent have an integrable real-valued count power under the Poisson law. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.integrable_nestedPairedTotalCount_pow` | `MeasureTheory.Integrable (fun x => ↑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedTotalCount x) ^ degree) (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates and a natural-number exponent have an integrable power of the nested array's total count. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.memLp_nestedPairedPoisson_of_polynomial_bound` | `Measurable F → ∀ (C : ℝ) (degree : ℕ), 0 ≤ C → (∀ (x : iota → kappa → ℕ × ℕ), \|F x\| ≤ C * (1 + ↑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedTotalCount x)) ^ degree) → MeasureTheory.MemLp F 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates, a measurable real-valued nested-array statistic, a nonnegative growth constant, and a polynomial degree whose absolute value obeys the stated total-count growth bound give a square-integrable statistic under the nested paired-count law. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.memLp_nestedPairAddOneFst_of_polynomial_bound` | `Measurable F → ∀ (C : ℝ) (degree : ℕ), 0 ≤ C → (∀ (x : iota → kappa → ℕ × ℕ), \|F x\| ≤ C * (1 + ↑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedTotalCount x)) ^ degree) → ∀ (i : iota) (j : kappa), MeasureTheory.MemLp (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairAddOneFst i j F) 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates, a measurable real-valued nested-array statistic, a nonnegative growth constant, a polynomial degree, its total-count growth bound, and a selected cell give a square-integrable first-count add-one increment. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.memLp_nestedPairAddOneSnd_of_polynomial_bound` | `Measurable F → ∀ (C : ℝ) (degree : ℕ), 0 ≤ C → (∀ (x : iota → kappa → ℕ × ℕ), \|F x\| ≤ C * (1 + ↑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedTotalCount x)) ^ degree) → ∀ (i : iota) (j : kappa), MeasureTheory.MemLp (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairAddOneSnd i j F) 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates, a measurable real-valued nested-array statistic, a nonnegative growth constant, a polynomial degree, its total-count growth bound, and a selected cell give a square-integrable second-count add-one increment. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.memLp_nestedPairedPoisson_and_addOne_of_polynomial_bound` | `Measurable F → ∀ (C : ℝ) (degree : ℕ), 0 ≤ C → (∀ (x : iota → kappa → ℕ × ℕ), \|F x\| ≤ C * (1 + ↑(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedTotalCount x)) ^ degree) → MeasureTheory.MemLp F 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂) ∧ (∀ (i : iota) (j : kappa), MeasureTheory.MemLp (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairAddOneFst i j F) 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)) ∧ ∀ (i : iota) (j : kappa), MeasureTheory.MemLp (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairAddOneSnd i j F) 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates, a measurable real-valued nested-array statistic, a nonnegative growth constant, a polynomial degree, and its total-count growth bound give all square-integrability premises for the nested paired-Poisson Poincaré inequality. |
<!-- /GEN -->

<!-- GEN:Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.Factorization -->
| Decl | Signature | Description |
|---|---|---
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedCoordinateProduct` | `(Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.NestedPairedPoissonIndex iota kappa → ℕ → ℝ) → (iota → kappa → ℕ × ℕ) → ℝ` | A scalar function at each flattened coordinate and a nested count-pair array determine their flattened coordinate product, given by multiplying the coordinate functions evaluated at the flattened counts. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.integral_nestedPairedCoordinateProduct_eq_prod` | `∫ (x : iota → kappa → ℕ × ℕ), Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedCoordinateProduct g x ∂Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂ = ∏ p, ∫ (n : ℕ), g p n ∂ProbabilityTheory.poissonMeasure (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonRates lambda₁ lambda₂ p)` | Two arrays of nonnegative Poisson rates and one scalar function for each flattened coordinate have a nested paired-count product integral equal to the product of scalar Poisson integrals. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.integral_sq_nestedPairedCoordinateProduct_eq_prod` | `∫ (x : iota → kappa → ℕ × ℕ), Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedCoordinateProduct g x ^ 2 ∂Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂ = ∏ p, ∫ (n : ℕ), g p n ^ 2 ∂ProbabilityTheory.poissonMeasure (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonRates lambda₁ lambda₂ p)` | Two arrays of nonnegative Poisson rates and one scalar function for each flattened coordinate have the squared nested coordinate-product integral equal to the product of scalar second moments. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.memLp_two_nestedPairedCoordinateProduct` | `(∀ (p : Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.NestedPairedPoissonIndex iota kappa), MeasureTheory.Integrable (fun n => g p n ^ 2) (ProbabilityTheory.poissonMeasure (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedPoissonRates lambda₁ lambda₂ p))) → MeasureTheory.MemLp (Causalean.Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.nestedPairedCoordinateProduct g) 2 (Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂)` | Two arrays of nonnegative Poisson rates, one scalar function for each flattened coordinate, and integrable scalar squared functions give a square-integrable nested flattened coordinate product. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.integral_nestedPaired_cellwise_product_eq_prod` | `∫ (x : iota → kappa → ℕ × ℕ), ∏ i, ∏ j, g₁ i j (x i j).1 * g₂ i j (x i j).2 ∂Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂ = ∏ i, ∏ j, (∫ (n : ℕ), g₁ i j n ∂ProbabilityTheory.poissonMeasure (lambda₁ i j)) * ∫ (n : ℕ), g₂ i j n ∂ProbabilityTheory.poissonMeasure (lambda₂ i j)` | Two arrays of nonnegative Poisson rates and first- and second-count scalar functions in every cell have their cellwise nested product integral factored into scalar Poisson integrals. |
| `Mathlib.Probability.PoissonAddOnePoincare.NestedPairedProductMoments.integral_sq_nestedPaired_cellwise_product_eq_prod` | `∫ (x : iota → kappa → ℕ × ℕ), (∏ i, ∏ j, g₁ i j (x i j).1 * g₂ i j (x i j).2) ^ 2 ∂Causalean.Mathlib.Probability.PoissonAddOnePoincare.nestedPairedPoissonMeasure lambda₁ lambda₂ = ∏ i, ∏ j, (∫ (n : ℕ), g₁ i j n ^ 2 ∂ProbabilityTheory.poissonMeasure (lambda₁ i j)) * ∫ (n : ℕ), g₂ i j n ^ 2 ∂ProbabilityTheory.poissonMeasure (lambda₂ i j)` | Two arrays of nonnegative Poisson rates and first- and second-count scalar functions in every cell have their squared cellwise nested product integral factored into scalar Poisson second moments. |
<!-- /GEN -->
