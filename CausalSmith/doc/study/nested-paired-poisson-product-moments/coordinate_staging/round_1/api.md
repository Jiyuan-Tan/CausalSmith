...
### Nested paired product moments

Nested arrays with two independent Poisson counts per cell can be flattened into one finite independent-count vector. The accompanying modules supply the transport, polynomial-growth L² criteria, and product-integral factorization used to discharge nested Poincaré energy bounds.
