...
/-- [A finite nested array of count pairs](hyp:x) determines [its total count across both entries of every cell](goal), given by [summing the two counts in every cell](step:1). -/
...
/-- [A nonnegative Poisson rate](hyp:lambda) and [a natural-number power](hyp:degree) yield [an integrable real-valued power of the Poisson count](goal). -/
...
/-- [The first-rate array](hyp:lambda₁), [the second-rate array](hyp:lambda₂), and [a natural-number power](hyp:degree) yield [an integrable power of the nested array's total count](goal). -/
...
/-- [The first-rate array](hyp:lambda₁), [the second-rate array](hyp:lambda₂), [a real-valued nested-array statistic](hyp:F), [its measurability](hyp:hF), [a growth constant](hyp:C), [a polynomial degree](hyp:degree), [nonnegativity of the growth constant](hyp:hC), and [the stated total-count polynomial bound](hyp:hbound) imply [that the statistic is square-integrable under the nested paired-count law](goal). -/
...
/-- [The first-rate array](hyp:lambda₁), [the second-rate array](hyp:lambda₂), [a real-valued nested-array statistic](hyp:F), [its measurability](hyp:hF), [a growth constant](hyp:C), [a polynomial degree](hyp:degree), [nonnegativity of the growth constant](hyp:hC), [the stated total-count polynomial bound](hyp:hbound), [an outer cell index](hyp:i), and [a within-cell index](hyp:j) imply [that the first-count add-one increment is square-integrable](goal). -/
...
/-- [The first-rate array](hyp:lambda₁), [the second-rate array](hyp:lambda₂), [a real-valued nested-array statistic](hyp:F), [its measurability](hyp:hF), [a growth constant](hyp:C), [a polynomial degree](hyp:degree), [nonnegativity of the growth constant](hyp:hC), [the stated total-count polynomial bound](hyp:hbound), [an outer cell index](hyp:i), and [a within-cell index](hyp:j) imply [that the second-count add-one increment is square-integrable](goal). -/
...
/-- [The first-rate array](hyp:lambda₁), [the second-rate array](hyp:lambda₂), [a real-valued nested-array statistic](hyp:F), [its measurability](hyp:hF), [a growth constant](hyp:C), [a polynomial degree](hyp:degree), [nonnegativity of the growth constant](hyp:hC), and [the stated total-count polynomial bound](hyp:hbound) imply [that the statistic and every first- and second-count add-one increment are square-integrable](goal). -/
