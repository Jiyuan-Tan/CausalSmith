...
variation converges in probability to one](goal). [The remaining declared inputs](hyp:A,v) determine [the stated conclusion](goal). -/
...
conditional Lindeberg condition holds at every positive threshold](goal). [The remaining declared inputs](hyp:A) determine [the stated conclusion](goal). -/
...
fourth-moment row sums converge in probability to zero](goal). [The remaining declared inputs](hyp:A) determine [the stated conclusion](goal). -/
...
/-- If [every increment has a finite fourth moment](hyp:hFourth) and [the deterministic
sum of unconditional fourth moments tends to zero](hyp:hFourthSum), then [the conditional
Lindeberg condition holds at every positive threshold](goal). [The remaining declared inputs](hyp:A) determine [the stated conclusion](goal). -/
