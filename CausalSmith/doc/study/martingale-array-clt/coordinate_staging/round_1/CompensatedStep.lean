...
before that increment, is its one-step predictable variance. [The remaining declared inputs](hyp:A,n,k) determine [the defined object](goal). -/
...
one-step predictable variances of the first `r` active increments. [The remaining declared inputs](hyp:A,n,r) determine [the defined object](goal). -/
...
/-- The partial predictable quadratic variation at time zero is zero. [The remaining declared inputs](hyp:A,n) determine [the stated conclusion](goal). -/
...
moment](goal). [The remaining declared inputs](hyp:A,n,k) determine [the stated conclusion](goal). -/
...
with respect to the row filtration at time `r`. [The remaining declared inputs](hyp:A,n,r) determine [the stated conclusion](goal). -/
...
by the partial predictable quadratic variation. [The remaining declared inputs](hyp:A,n,r,t) determine [the defined object](goal). -/
...
weight times the exact conditionally centered quadratic update](goal). [The remaining declared inputs](hyp:A,n,k,t,K) determine [the stated conclusion](goal). -/
...
remainder and the squared one-step predictable variance](goal). [The remaining declared inputs](hyp:A,n,k,t,K) determine [the stated conclusion](goal). -/
