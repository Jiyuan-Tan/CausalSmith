...
predictable-mesh budget](goal). [The martingale array, row, frequency, truncation level, and budgets](hyp:A,n,t,η,K,δ) parameterize [the stated conclusion](goal). -/
...
expected distance of predictable quadratic variation from one](goal). [The martingale array, row, frequency, truncation level, and budgets](hyp:A,n,t,η,K,δ) parameterize [the stated conclusion](goal). -/
