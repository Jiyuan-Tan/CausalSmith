...
zero](goal). [The remaining declared inputs](hyp:X) determine [the stated conclusion](goal). -/
...
remainder](goal). [The remaining declared inputs](hyp:X,t) determine [the stated conclusion](goal). -/
...
integral](goal). [The remaining declared inputs](hyp:f,g,B) determine [the stated conclusion](goal). -/
...
most that constant times the integral norm of the original error](goal). [The remaining declared inputs](hyp:f,g,B) determine [the stated conclusion](goal). -/
...
term plus the truncated second moment of the large jumps](goal). [The remaining declared inputs](hyp:X,t,η) determine [the stated conclusion](goal). -/
