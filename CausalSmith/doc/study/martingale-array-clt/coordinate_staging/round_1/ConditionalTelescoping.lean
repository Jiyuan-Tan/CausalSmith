...
at the row length. [The remaining declared inputs](hyp:A,n,r) determine [the defined object](goal). -/
...
conditional quadratic expansion](goal). [The remaining declared inputs](hyp:A,n,k,t) determine [the stated conclusion](goal). -/
...
expected norm of its Taylor remainder](goal). [The remaining declared inputs](hyp:A,n,k,t) determine [the stated conclusion](goal). -/
...
bounded by the sum of the expected one-increment Taylor remainders](goal). [The remaining declared inputs](hyp:n,t) determine [the stated conclusion](goal). -/
