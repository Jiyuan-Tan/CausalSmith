...
/-- The row sum is the sum of the increments whose indices are below that row's length. [The remaining declared inputs](hyp:A,n) determine [the defined object](goal). -/
...
moments of its increments, each conditioned on the preceding filtration time. [The remaining declared inputs](hyp:A,n) determine [the defined object](goal). -/
...
discarding values whose absolute size is at most the chosen threshold. [The remaining declared inputs](hyp:A,ε,n,k) determine [the defined object](goal). -/
...
over all increments in that row. [The remaining declared inputs](hyp:A,ε,n) determine [the defined object](goal). -/
...
increments, each conditioned on the preceding filtration time. [The remaining declared inputs](hyp:A,n) determine [the defined object](goal). -/
...
the increments in one row. [The remaining declared inputs](hyp:A,n) determine [the defined object](goal). -/
