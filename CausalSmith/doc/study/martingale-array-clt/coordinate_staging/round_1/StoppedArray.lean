...
`k`. [The remaining declared inputs](hyp:A,n,k) determine [the defined object](goal). -/
...
at most `k`. [The remaining declared inputs](hyp:A,ε,n,k) determine [the defined object](goal). -/
...
`k` remain within the supplied budgets, and is zero otherwise. [The remaining declared inputs](hyp:A,ε,K,δ,n,k) determine [the defined object](goal). -/
...
at the preceding filtration time](goal). [The remaining declared inputs](hyp:A,ε,K,δ,n,k) determine [the stated conclusion](goal). -/
...
/-- Stopping does not change the row length. [The remaining declared inputs](hyp:A,ε,K,δ,n) determine [the stated conclusion](goal). -/
...
zero-one stopping multiplier. [The remaining declared inputs](hyp:A,ε,K,δ,n,k) determine [the stated conclusion](goal). -/
...
leaves the row sum unchanged almost everywhere](goal). [The remaining declared inputs](hyp:A,ε,K,δ,n) determine [the stated conclusion](goal). -/
...
everywhere](goal). [The remaining declared inputs](hyp:A,ε,K,δ,n) determine [the stated conclusion](goal). -/
...
at that threshold never exceeds its budget almost everywhere](goal). [The remaining declared inputs](hyp:A,ε,K,δ,n) determine [the stated conclusion](goal). -/
...
row exceeds either stopping budget](goal). [The remaining declared inputs](hyp:A,ε,K,δ,n) determine [the stated conclusion](goal). -/
