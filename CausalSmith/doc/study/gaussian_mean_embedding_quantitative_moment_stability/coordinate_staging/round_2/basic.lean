...
/-- A real Hilbert space determines a unit-norm feature realization of the unit-scale
Gaussian kernel.  It consists of a feature map, a certificate that every feature vector
has unit norm, and a certificate that feature-vector inner products equal the kernel. -/
