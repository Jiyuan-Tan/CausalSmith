...
### Efron bootstrap mean central limit theorem

For a measurable scalar statistic with a finite second moment, these modules identify the
centered Efron mean bootstrap with a triangular iid row and establish its Bickel--Freedman
almost-sure weak and Kolmogorov consistency. The statistic-level result is designed for
linearized estimators as well as literal real-valued sample means.

<!-- GEN:Causalean.Stat.Bootstrap.EfronResampling.MeanCLT -->
_(no documented declarations in Causalean.Stat.Bootstrap.EfronResampling.MeanCLT)_
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronResampling.MeanCLT.Basic -->
_(no documented declarations in Causalean.Stat.Bootstrap.EfronResampling.MeanCLT.Basic)_
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronResampling.MeanCLT.AlmostSure -->
_(no documented declarations in Causalean.Stat.Bootstrap.EfronResampling.MeanCLT.AlmostSure)_
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.EfronResampling.MeanCLT.Main -->
_(no documented declarations in Causalean.Stat.Bootstrap.EfronResampling.MeanCLT.Main)_
<!-- /GEN -->
