...
public import Causalean.Stat.Bootstrap.AsymptoticLinearity.LimitLemmas
public import Mathlib.MeasureTheory.Measure.LevyConvergence

/-!
# Bootstrap-law convergence for asymptotically linear estimators

This module proves convergence of the sampling and conditional bootstrap laws to their common
centered Gaussian limit, and consequently their mutual Kolmogorov consistency. The quantile and
coverage consequences are developed in the companion main module.
-/
...
/-- When [an estimator has bootstrap asymptotic linearity](hyp:h), [its square-root-scaled
sampling distribution converges weakly to its centered Gaussian influence-function law](goal). -/
...
/-- When [an estimator has bootstrap asymptotic linearity](hyp:h), [its conditional centered
bootstrap law converges in sampling probability in Kolmogorov distance to its centered Gaussian
influence-function law](goal). -/
...
/-- When [an estimator has bootstrap asymptotic linearity](hyp:h), [its conditional bootstrap
law and its sampling law become uniformly close in Kolmogorov CDF distance, in sampling
probability](goal). -/
