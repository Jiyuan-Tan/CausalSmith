...
This API turns sampling and conditional bootstrap linearizations into reusable bootstrap
distribution, quantile, and coverage results. The sample-mean constructor is the canonical
ready-to-use instance; other estimators supply the same bundled hypothesis.

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinearity.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinearity.Convergence -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinearity.LimitLemmas -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinearity.Main -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinearity.SampleMean -->
<!-- /GEN -->
