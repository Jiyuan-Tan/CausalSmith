...
This interface packages the usual nonparametric-bootstrap conclusion for estimators with both
sampling and conditional bootstrap asymptotic linearizations.  Constructors for estimator classes
belong beside those classes; consumers then use `BootstrapAsymLinear`'s consistency, quantile, and
coverage theorems.

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinear.Basic -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinear.LimitLemmas -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinear.Main -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinear.Coverage -->
<!-- /GEN -->

<!-- GEN:Causalean.Stat.Bootstrap.AsymptoticLinear.SampleMean -->
<!-- /GEN -->
