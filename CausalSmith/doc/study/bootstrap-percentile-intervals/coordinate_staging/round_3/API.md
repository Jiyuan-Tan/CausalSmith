...
The bootstrap interface below packages sampling and conditional linearizations of an estimator,
then supplies conditional-law consistency, quantile convergence, and nominal coverage for
percentile and basic confidence intervals.  The sample-mean constructor is the canonical
