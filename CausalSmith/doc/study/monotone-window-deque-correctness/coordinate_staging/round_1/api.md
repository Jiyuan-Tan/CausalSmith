...
## Mathlib/Algorithms/MonotoneWindowDeque/ — monotone-window deque scans

This reusable algorithmic substrate certifies the standard rightmost-stable monotone deque for maxima over finite streams with nondecreasing contiguous windows. It exposes the invariant, scan correctness, exact event accounting, window-width storage bounds, and constant-pass composition.
