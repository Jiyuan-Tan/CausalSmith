...
averaging over unrevealed coordinates while holding revealed coordinates fixed [by the stated finite sum](step:1). -/
...
[their total second moment is one](hyp:hsecond), and [the supplied Heyde--Brown premise holds](hyp:hHeydeBrown),
