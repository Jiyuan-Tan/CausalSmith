...
This reusable finite-dimensional substrate supplies positive top eigenvectors for symmetric irreducible nonnegative matrices, together with the absolute-value and block-restriction bridges used to apply them on connected finite components.
