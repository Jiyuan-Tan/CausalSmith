...
/-- Given a [number of centers](hyp:k), [at least one center](hyp:hk), [centers](hyp:center),
[radii](hyp:radius), and [positive radii](hyp:hr), a [measurable selector](goal) chooses a
center within its radius at every covered point. -/
