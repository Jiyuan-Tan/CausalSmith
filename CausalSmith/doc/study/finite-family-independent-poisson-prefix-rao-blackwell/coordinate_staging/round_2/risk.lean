...
Authors: Jiyuan Tan
-/
import Causalean.Stat.FiniteRaoBlackwell.IndependentPoissonPrefix.FiniteFamily.Basic
...
overflow value in it](hyp:hzOver), [conditional averaging cannot increase squared risk relative
to the capped randomized experiment](goal). -/
    ...
    sqRisk (fixedPoolsLaw P N)
      ...
      sqRisk μ (cappedPrefixStatistic T zOver) theta := by
        exact sqRisk_prefixRaoBlackwellStatistic_le_capped
          P lambda N hT hab hTmem htheta hzOver
