...
\tag{13}
\]
The uniform distributional convergence in (12) and (13) prove the asserted Wald coverage.  The source carrier in Lemma~\(\mathrm{lem:saco\text{-}pointwise\text{-}rqv\text{-}pivot}\) records exactly the ten numbered source conditions retained by the definition.  The extra premise used above is precisely (8), so the theorem's class is their intersection with early QV stabilization, as claimed.