...
\]
If, in addition, \(\Delta_n\log c_{2,n}\to0\), then \(\Gamma_{12,n}(t_n)\to1\). If moreover \(\lambda_n\to\lambda\in[-\infty,+\infty]\), then
\[
\bigl(\Gamma_{12,n}(t_n),\Gamma_{21,n}(t_n),D_n(t_n)\bigr)
\longrightarrow
\begin{cases}
(1,1,0), & \lambda=-\infty,\\
\left(1,\displaystyle\frac12+\frac12\frac{\beta_0^{\alpha_0}c_0e^{-\lambda/\alpha_0}}{1+\beta_0^{\alpha_0}c_0e^{-\lambda/\alpha_0}},
