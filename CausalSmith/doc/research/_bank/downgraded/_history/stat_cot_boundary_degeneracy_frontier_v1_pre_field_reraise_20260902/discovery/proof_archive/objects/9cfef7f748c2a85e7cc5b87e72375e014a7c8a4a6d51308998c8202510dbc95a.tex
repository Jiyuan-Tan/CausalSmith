...
\]
and (17) prove the stated conditional Lindeberg conclusion after summation and expectation.

Finally, direct expansion gives
\[
\sum_rE(\mathcal D_{n,r}^2\mid\mathcal F_{r-1})
=EG_n^2+C_n+R_n+T_n, \tag{18}
\]
where
\[
\begin{split}
...
\]
The centering in (23) is exact because martingale differences are pairwise orthogonal, so the expectation of (18) equals \(E(G_n+n\mathbb U_{J_y,J_z,n})^2\). Equations (1)--(23) prove all asserted localization, moment, influence, four-cycle, mixed-contraction, Lindeberg, and predictable-variance bounds.