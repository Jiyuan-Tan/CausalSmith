...
| | score | tier |
|---|---|---|
| original in-pipeline D0.5.G (old rule) | 8.0 | field |
| anchored re-score (new rule) | **7.6** | **subfield** |
...
- state at stop: `stage_completed` around F2/2.5; run was ~16h into the F stages
