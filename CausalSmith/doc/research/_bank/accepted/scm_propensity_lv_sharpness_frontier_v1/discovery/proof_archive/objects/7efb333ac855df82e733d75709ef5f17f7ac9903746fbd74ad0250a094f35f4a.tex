...
We next prove the cap characterization.  If (1) holds, then \(Q(B)\ge eP(B)\) for every measurable \(B\).  Consequently \(P\ll Q\).  For \(r=dP/dQ\), the measure inequality \(eP\le Q\) implies \(er\le1\), \(Q\)-almost surely; otherwise integrating \(er-1\) on the positive-measure set where it is positive would contradict \(ePle Q\).  Thus \(r\le1/e\).  Conversely, suppose \(P\ll Q\) and \(r=dP/dQ\le1/e\), \(Q\)-almost surely.  Define
\[
