The causal target is the set of equilibrium responses over \(\mathfrak F_x^{\mathrm{law}}(P_X)\); the deletion-rank sets are observable-law functionals only after their equality to that target and their invariance to the choice of exact mixing representative have been proved.
