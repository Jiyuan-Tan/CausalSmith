...
open Causalean Causalean.Graph
...
example :
  ...
  · refine
      { base := fun _ ↦ false
        ...
        parent₁ := true
        nonzero := ?_ }
    norm_num [PositiveFiniteDAGMechanism.localContrast,
      PositiveFiniteDAGMechanism.factorAccessor, PositiveFactor.localContrast,
      binaryMechanism, Function.update]
