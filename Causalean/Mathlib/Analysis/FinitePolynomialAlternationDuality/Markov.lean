...
Authors: Jiyuan Tan
-/
import Causalean.Mathlib.Analysis.FinitePolynomialAlternationDuality.Affine
import Causalean.Mathlib.Analysis.FinitePolynomialAlternationDuality.MarkovUnit
