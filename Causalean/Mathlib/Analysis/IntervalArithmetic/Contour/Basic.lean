...
/-!
# Rational square and square-root interval bounds

This module extends rational intervals with sign-aware squaring, Newton
square-root enclosures, convergence and width bounds, and endpoint-magnitude
estimates. Complex rectangle operations and certified complex names live in
`Causalean.Mathlib.Analysis.IntervalArithmetic.Contour.Rectangles` and
`Causalean.Mathlib.Analysis.IntervalArithmetic.Contour.Names`, respectively.
-/
...
/-- The gap between the Newton lower and upper square-root bounds is eventually
below every positive rational tolerance. -/
