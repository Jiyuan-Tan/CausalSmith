...
/-- [The finite-measure marked Poisson law is a probability measure](goal) on
[a measurable observation space](hyp:X), for [a finite intensity measure](hyp:ν),
[a fallback probability law](hyp:P₀), [a real-valued mark law](hyp:R), and
[a nonnegative scalar intensity](hyp:lam). -/
...
/-- For [two finite intensity measures](hyp:ν₀,ν₁), [a fallback probability law](hyp:P₀),
[a real-valued mark law](hyp:R), and [a nonnegative scalar intensity](hyp:lam), if
[the intensity measures have equal total mass](hyp:hmass),
[their marked Poisson divergence is the scalar intensity times their divergence](goal). -/
...
/-- For [two finite intensity measures](hyp:ν₀,ν₁), [a fallback probability law](hyp:P₀),
[a real-valued mark law](hyp:R), [a nonnegative scalar intensity](hyp:lam), and
[a divergence budget](hyp:B), if [the measures have equal total mass](hyp:hmass) and
[their divergence is within the budget](hyp:hKL),
[the marked-experiment divergence is at most the scaled budget](goal). -/
