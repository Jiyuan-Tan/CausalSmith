...
/-- [The canonical mark-ordered Poisson sample law is a probability measure](goal) for
...
[cell restriction gives the product of independent canonical cell laws](goal). -/
...
/-- **Superposition recovers the canonical global law.** For
[a measurable classifier partition](hyp:p), [an observation probability law](hyp:P),
[an atomless real-valued mark law](hyp:R), and [a nonnegative intensity](hyp:lam), independently
sample each cell at its mass-scaled intensity.
[Their mark-ordered superposition recovers the canonical global law](goal). -/
