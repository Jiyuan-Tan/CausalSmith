...
/-! `Causalean.SCM.Do.Rule2Kernel.WitnessBridge`: barrel re-exporting the parts under `WitnessBridge/` (the former single file was split in R3; the mathematics lives in the parts). -/
