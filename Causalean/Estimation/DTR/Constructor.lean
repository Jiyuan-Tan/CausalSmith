...
lemma exists_stage0_lift (S : POLongitudinalPathSystem P 2 δ γ) (g : P.Ω → ℝ)
  ...
  have hBmeas :
    ...
    intro i
    dsimp [B, t, POLongitudinalPathSystem.historyBundle, POCFBundle.jointValue, POCFBundle.cons,
      POCFBundle.nil, RegimedVar.ofFactual, RegimedVar.value, POLongitudinalPathSystem.factualS]
    fin_cases i
    exact ht
...
lemma exists_stage1_lift (S : POLongitudinalPathSystem P 2 δ γ) (g : P.Ω → ℝ)
  ...
  have hBmeas :
    ...
    dsimp [B, t, POLongitudinalPathSystem.historyBundle, POCFBundle.jointValue, POCFBundle.cons,
      POCFBundle.nil, RegimedVar.ofFactual, RegimedVar.value, POLongitudinalPathSystem.factualS,
      POLongitudinalPathSystem.factualD, POLongitudinalPathSystem.dVar]
    fin_cases i
    · exact hS1
    · exact hD0
    · exact hS0
...
noncomputable def _root_.Causalean.PO.POLongitudinalPathSystem.toDTREstimationSystem
    (S : POLongitudinalPathSystem P 2 δ γ) (dbar : Fin 2 → δ)
    (hov0 : ∀ᵐ ω ∂P.μ,
