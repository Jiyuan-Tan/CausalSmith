...
/-! # Products of finite probability distributions
...
/-- For a finite, equality-comparable index set whose coordinate finite types are finite,
[a family of coordinate-specific finite probability distributions](hyp:D) defines [the product design](goal),
