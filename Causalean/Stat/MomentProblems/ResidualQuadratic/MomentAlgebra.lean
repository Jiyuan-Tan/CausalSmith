...
This is the measure-free algebra layer for the `ResidualQuadratic` namespace. It works only with raw
...
/-- Given [a real support parameter](hyp:t), the [first moment of the extremal three-point
law](goal)
