...
module
public import Causalean.Stat.MomentProblems.ResidualQuadratic.MeasureBridge
...
contains exactly the quadratic least-squares residuals of probability measures that are almost
surely
